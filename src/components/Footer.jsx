const Footer = () => {
  ...
  const socialLinks = [
    { name: 'LinkedIn', href: 'https://www.linkedin.com/company/inikola/posts/?feedView=all', icon: 'M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2z' },
